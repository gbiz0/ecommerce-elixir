defmodule CommerceServerWeb.Router do
  use CommerceServerWeb, :router
  ...
  if Application.compile_env(:commerce_server, :dev_routes) do
  ...
  scope "/", CommerceServerWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{CommerceServerWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", CommerceServerWeb do
    ...
    live_session :current_user,
      on_mount: [{CommerceServerWeb.UserAuth, :mount_current_scope}] do
